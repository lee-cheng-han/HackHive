...
def create_cree_basics_course(db: Session, teacher_id):
    ...
    exercises_lesson1 = [
        ...
        Exercise(
            ...
            question="Match the Cree words with their English translations",
            question_translation="Draw connections between matching pairs",
            options=[
                {"id": "1a", "text": "ᑖᓂᓯ", "match": "hello"},
                {"id": "1b", "text": "ᐁᑯᓯ", "match": "goodbye"},
                {"id": "1c", "text": "ᑭᓇᓈᐢᑯᒥᑎᐣ", "match": "thank you"},
            ],
            correct_answer=["1a-hello", "1b-goodbye", "1c-thank you"],
            explanation="Learning these basic greetings helps you start any conversation respectfully.",
            order=4,
            points=15,
        ),
        Exercise(
