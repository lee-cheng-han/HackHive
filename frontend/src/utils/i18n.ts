...
export const translations: Record<LanguageCode, Record<string, string>> = {
  ...
  cr: {
    ...
    'nav.courses': 'ᐊᐢᑭᐦᐊᐧᐠ',
    'nav.community': 'ᐚᐢᑭᐦᐃᑲᐧᐣ',
    'nav.settings': 'ᐸᑭᑎᓀᐤ',
    
    // Dashboard
    'dashboard.welcome': 'ᑕᐧᐋᐧᐤ',
    'dashboard.wordsLearned': 'ᐊᔮᐦᑵᒣᐤ',
    'dashboard.storiesCompleted': 'ᐋᒋᒧᓯᐢ',
    'dashboard.dayStreak': 'ᑮᓯᑳᐤ',
    'dashboard.currentLevel': 'ᐊᒥᐢᑭᐤ',
    'dashboard.recommended': 'ᓰᐦᑭᒥᐤ',
    'dashboard.progress': 'ᐊᒋᒧᐯᐤ',
    'dashboard.continueJourney': 'ᑲᔭ ᒪᐦᒋ ᐱᒻᐦᐃᑯᐦᐊᐣ ᐅᒪ ᐚᔭᔦᐃᐧᐸᒪᑫᐃᐧᐣ',
    'dashboard.thisWeek': 'ᐅᒪ ᐊᔭᒥᐦᐃᑭᐦᐠ',
    'dashboard.weeklyGoal': 'ᐊᔭᒥᐦᐃᑭᐦᐠ ᐃᑯᐣ',
    'dashboard.level.beginner': 'ᓇᑲᒧᐣ',
    'dashboard.level.intermediate': 'ᒐᐸᓂᐢᐠ',
    'dashboard.level.advanced': 'ᑮᐢᒋᓀᐤ',
    'dashboard.recommendationsDescription': 'ᐃᑲ ᑭᔭ ᐱᒥᐦᐃᐤ ᑲᔦ ᑭᔭ ᐊᒋᒧᓯᓯᓇ',
    'dashboard.recommendationsPlaceholder': 'ᐅᒪ ᑲᔦ ᐚᐸᐦᑕᒼ ᓰᐦᑭᒥᓇ',
    'dashboard.trendFromLastWeek': 'ᐊᓭᓇᒪᐍᐤ ᐊᔭᒥᐦᐃᑭᐦᐠ',
    ...
    'common.save': 'ᐊᔭᐢᑯᐍᐤ',
    'common.cancel': 'ᐘᑯᓇᐍᐤ',
    'common.confirm': 'ᑲᔦ ᐚᐱᓇᐧᐃᓯᐤ',
    'common.delete': 'ᐊᔭᒥᐦᐋᐤ',
    'common.edit': 'ᐃᐦᑎᐤ',
    'common.close': 'ᑭᐸᐦᐊᒪᐍᐤ',
    'common.back': 'ᓇᔭᐦᑕᒼ',
    'common.next': 'ᒪᐚᐠ',
    'common.previous': 'ᐊᔭᒥᐦᐃᑭᐦᐠ',
    'common.submit': 'ᐱᒥᐦᐃᑾᐤ',
    'common.upload': 'ᓲᐢᑿᒋᐍᐤ',
    'common.download': 'ᐯᐦᑕᐍᐤ',
    'common.beginner': 'ᓇᑲᒧᐣ',
    'common.practice': 'ᐸᐱᒋ ᑭᐢᑭᓀᐤ',
